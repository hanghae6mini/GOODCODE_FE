...
import { auth } from '../redux/module/__Login'
    ...
    return (
        <React.Fragment>
            ...
            <Grid flex_space padding='16px'>
                ...
                <Grid width='50vw' bg='#999' margin='160px auto' rad='20px'>

                    <Grid width='90%' margin='50px auto 0 auto' border='3px solid white' rad='20px' padding='10px' bg='eee'>
                        <Upload />
                    ...
                    <Grid flex_col width='100%'>
                        <Grid flex_col>
                            <Grid width='90%' margin='50px auto' rad='20px'>
                                {feed_list.list.map((v, i) => {
                                    return (
                                        <div key={i}>
                                            <Feed data={v} image={v.image !== '' ? v.image : ''}></Feed>
                                        </div>
                                    )
                                })}
                            </Grid>
